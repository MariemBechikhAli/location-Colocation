  ...
  <section id="container" class="">
     ...
     <a href="index.jsp" class="logo">Ekri <span class="lite">.tn</span></a>
      ...
      <div class="nav search-row" id="top_menu">
        ...
        <ul class="nav top-menu">
          <li>
            <form class="navbar-form" action="rechercheann.jsp">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <h1> Listes des annonces des colocataires</h1>
   <%   try{
   ...
   String req="select * from annoncecolocataire where message like('%"+type+"%') ";
...
%>
                      <div class="btn-group">
                        <a class="btn btn-primary" href="etat1?id=<%=rs.getString(1)%>"> <i class="icon_check_alt2"></i></a>
                        <a class="btn btn-danger" href="supp.jsp?id=<%=rs.getString(1)%>"><i class="icon_trash_alt"></i></a>
                      </div>
<%
    } else{
         out.print("<tr> <td>"+rs.getString(2)+"<td>"+rs.getString(8)+"<td>"+rs.getString(11)+"<td>"+rs.getString(12)+"<td>"+rs.getString(13)+"<td>"+rs.getString(14)+"<td>"+rs.getString(15)+"<td>"+rs.getString(18)+"<td>"+rs.getString(19)+"<td>");
   %> 
               <div class="btn-group">
                        <a class="btn btn-success" href="etat?id=<%=rs.getString(1)%>"> <i class="icon_check_alt2"></i></a>
                        <a class="btn btn-danger" href="supp.jsp?id=<%=rs.getString(1)%>"><i class="icon_trash_alt"></i></a>
                      </div> 
   <% 
}
...
<br>
<h1> Listes des annonces des logements</h1>
   ...
   conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/base?autoReconnect=true&useSSL=false","root","admin");
  String type= request.getParameter("type");
   String req="select * from annoncelogement where description like('%"+type+"%') ";
    Statement stmt=conn.createStatement();
   ResultSet rs =stmt.executeQuery(req);
...
<table class="table">
                <thead>
                  <tr>
                      ...
                      <th><i class="icon_info"></i> Description</th>
                  <th> <i class="icon_upload"></i> Etat</th>
                  <th> <i class="icon_calendar"></i> Date publication</th>
                  <th><i class="icon_pin_alt"></i> Adresse</th>
                    ...
                    <th><i class="icon_archive"></i> Meuble ?</th>
                  <th><i class="icon_briefcase"></i>loyer</th>
                  <th><i class="icon_mail"></i> Contact</th>
                  <th><i class="icon_images"></i> Photo</th>
                  <th> <i class="icon_cogs"></i>Action</th>
  ...
  if (rs.getString(3).equals("Active")){
    out.print("<tr> <td>"+rs.getString(2)+ "<td>"+rs.getString(3)+" <td>"+rs.getString(4)+" <td>"+rs.getString(5)+"<td>"+rs.getString(7)+"<td>"+rs.getString(8)+"<td>"+rs.getString(10)+"<td>"+rs.getString(11)+"<td>"+rs.getString(12)+"<td>"+rs.getString(13)+"<td>");
 %>
                      <div class="btn-group">
                        <a class="btn btn-primary" href="etat3?id=<%=rs.getString(1)%>"> <i class="icon_check_alt2"></i></a>
                        <a class="btn btn-danger" href="supp_1.jsp?id=<%=rs.getString(1)%>"><i class="icon_trash_alt"></i></a>
                      </div>
<%
    }
else{
 ...
 %> 
               <div class="btn-group">
                        <a class="btn btn-success" href="etat2?id=<%=rs.getString(1)%>"> <i class="icon_check_alt2"></i></a>
                        <a class="btn btn-danger" href="supp_1.jsp?id=<%=rs.getString(1)%>"><i class="icon_trash_alt"></i></a>
                      </div> 
   <% 
} 
