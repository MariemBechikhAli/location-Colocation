...
<body>
        ...
        <ul class="nav pull-right top-menu">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
              ...
              <li>
                <a href="login.jsp"><i class="icon_key_alt"></i> Deconnéxion</a>              </li>
 ...
 try{
           ...
           String date_naiss1=request.getParameter("date_naiss");
           String email1=request.getParameter("email");
         String password1=request.getParameter("password");
        String photo1=request.getParameter("photo");
      Connexion C = new Connexion();
       String req="update administrateur set login='"+email1+"',nom='"+nom1+"',prenom='"+prenom1+"', date_naiss='"+date_naiss1+"',password='"+password1+"',photo='"+photo1+"'  where idAdmin="+id;
