...
<body>
  ...
  <!-- jQuery full calendar -->
    <body>
         <h1><em><strong>Gestion des abonnés </strong></em></h1>
        <%  
            try{
    Connexion C = new Connexion();
   String req="select * from annonceur";
    ResultSet rs = C.Afficher(req);
      ...
      <div class="btn-group">
                        ...
                        <a class="btn btn-danger" href="supprimer1.jsp?id=<%=rs.getString(1)%>" onclick="confirm('Vous voulez vraiment supprimer cet abonné')"><i class="icon_trash_alt"title="Supprimer"></i></a>
                      </div>
   <%
       } else{
              out.print("<tr><td>"+rs.getString(2)+"<td>"+rs.getString(3)+"<td>"+rs.getString(10)+"<td>"+rs.getString(4)+"<td>"+rs.getString(8)+"<td>"+rs.getString(9)+"<td>"+rs.getString(13)+"<td>");
 %>
          <div class="btn-group">
                        ...
                        <a class="btn btn-success" href="mod1?id=<%=rs.getString(1)%>"><i class="icon_check_alt2" title="Désactive"></i></a>
...
%>           
<div class="btn-group">
                       <a class="btn btn-success" href="etat5?id=<%=rs.getString(1)%>"><i class="icon_check_alt2" title="Désactive"></i></a>
                        <a class="btn btn-danger" href="supp2.jsp?id=<%=rs.getString(1)%>"><i class="icon_trash_alt"title="Supprimer"></i></a>
