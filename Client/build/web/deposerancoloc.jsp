            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-8 mb-5">
                        ...
                        <form action="deposerancoloc1.jsp" class="p-5 bg-white border" name="formulaire">
                                ...
                                <tr>
                                    ...
                                    <td width="266">  <div class="row form-group">
                                            <div class="col-md-12 mb-3 mb-md-0">
                                                ...
                                                <input type="text" name="prenom" id="fullname" class="form-control" value="" placeholder="Prénom"/>
                                            </div>
                                        </div></td>
                                </tr>
                                <tr>
                                    <td colspan="2"><div class="row form-group">
                                            <div class="col-md-12">
                                                ...
                                                <input type="email" id="email" name="email" class="form-control" placeholder="Courier électronique" />
                                            </div>
                                        </div></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td> <div class="row form-group">
                                            <div class="col-md-12">
                                                ...
                                                <input type="phone" id="subject" name="tel" class="form-control" placeholder=" Numero Telephonique " >
                                            </div>
                                        </div></td>
                            ...
                            <input type="submit" value="Publier" class="btn btn-success text-white btn-block rounded-0" name="valider" >
