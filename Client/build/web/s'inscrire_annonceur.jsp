    ...
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(images/hero_bg_2.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
            <div class="row align-items-center justify-content-center text-center">
                <div class="col-md-10">
                    <h1 class="mb-2">Cr�er un compte Annonceur</h1>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="col-md-12 mb-3 mb-md-0">
                                ...
                                <table width="806" border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td width="218">  <div class="row form-group">
                                                <div class="col-md-12 mb-3 mb-md-0">
                                    ...
                                    <tr><td>
                                            <div class="row form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="password"id="subject" name="passe" class="form-control" placeholder="Mot de passe" required="required"  minlength="6"
                                                           pattern="[A-Z]+[a-z]+[0-9]*"    title="Veuillez saisir un mot de passe avec au moins 6 caract�res, commancant par une lettre majuscule." autocomplete="nouveau-mot-de-passe">
                                                </div>
                                            </div>
                                        </td>
                                        <td width="10">   <span class="Style2">*</span></td>
                                        <td> <div class="row form-group">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="password"id="subject" name="confirm" class="form-control" placeholder="Re�crire le mot de passe" required="required">
                                                </div>
                                            </div></td>
                                        <td width="10">   <span class="Style2">*</span></td>
                                    </tr>
                                    <tr> <td colspan="3"> <span class="Style2">*: champs Obligatoires</span></td>
                                    </tr>
                                </table>
