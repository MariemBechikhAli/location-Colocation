        ...
        <div class="row">
          <div class="col-md-12">
            <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
              <div class="mr-auto">
                <a href="index.jsp" class="icon-view view-module"><span class="icon-view_module"></span></a>
                <a href="list-index.jsp" class="icon-view view-list active"><span class="icon-view_list"></span></a>
                
              </div>
              <div class="ml-auto d-flex align-items-center">
                <div>
                   <a href="index.jsp" class="view-list px-3 border-right active">Annonces logements</a>
                  <a href="list-indexvis-coloc.jsp" class="view-list px-3 border-right">Annonces colocataires</a>
                </div>
        ...
        <%
          ...
          <div class="col-md-12">
            <div class="property-entry horizontal d-lg-flex">
              ...
              <a href="detailsvis.jsp?idanlog1=<%=rs.getString(1)%>" class="property-thumbnail h-100">
                
                <img src="images/<%=rs.getString(11)%>" alt="Image" class="img-fluid">
              </a>
 
              <div class="p-4 property-body">
                <a href="detailsvis.jsp?idanlog1=<%=rs.getString(1)%>" </span></a>
