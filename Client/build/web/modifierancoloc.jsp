                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-8 mb-5">
                        ...
                        <%
                            ...
                            int idAn = 0;
                            int idancoloc = 0;
                            String idancoloc1 = request.getParameter("idannance");
                            try {
                                Connexion c = new Connexion();
                                String req = " select * from annoncecolocataire where idancoloc=" + idancoloc1 + "";
                                System.out.print("+++++++ " + req);
                                ResultSet rs = c.recherche(req);
                                while (rs.next()) {
                                    idancoloc = rs.getInt(1);
                                    nomp = rs.getString(2);
                        ...
                        <form action="update_annonce_coloc.jsp" class="p-5 bg-white border" name="formulaire">
                                 ...
                                 <tr>
                                    <td colspan="2"><div class="row form-group">
                                            <div class="col-md-12 mb-3 mb-md-0">
                                                ...
                                                <textarea type="text" name="description" id="Description" class="form-control" ><%=description%></textarea>
                                            </div>
                                        </div></td>
                                ...
                                <tr>
                                    ...
                                    <td> <div class="row form-group">
                                            <div class="col-md-12 mb-3 mb-md-0">
                                                ...
                                                <select name="adr" class="common-input mb-20 form-control">
                            ...
                            <input type="hidden" value="<%=idAn%>" name="idAn" >
                            <input type="hidden" value="<%=idancoloc%>" name="idancoloc" >
                            <input type="submit" value="Enregistrer" class="btn btn-success text-white btn-block rounded-0" name="valider" >
