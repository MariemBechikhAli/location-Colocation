...
<html lang="en">
  ...
  <div class="site-wrap">
        ...
        <div class="container py-1">
          <div class="row align-items-center">
            <div class="col-8 col-md-8 col-lg-4">
              <h1 class="mb-0"><a href="index_locataire.jsp" class="text-white h2 mb-0"><strong>Colocation.tn<span class="text-danger">.</span></strong></a></h1>
            </div>
            <div class="col-4 col-md-4 col-lg-8">
              <nav class="site-navigation text-right text-md-right" role="navigation">
                ...
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                  <li class="active">
                    <a href="index_locataire.jsp">Accueil</a>  </li>   
    ...
    <li class="has-children">
                    <a href="profilloc.jsp"><%=nom%></a>
                    <ul class="dropdown arrow-top">
                      <li><a class="icon-menu" href="boite.jsp"> Boite de reception</a></li>
                       <li><a  class="icon-room" href="profilloc.jsp">Mon Profil </a></li>
    ...
    <div class="site-section site-section-sm pb-0">
      <div class="container">
        <div class="row">
            <form class="form-search col-md-12" style="margin-top: -100px;" action="recherche.jsp">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
              <div class="mr-auto">
               <a href="annoncecoloc-loc.jsp" class="icon-view view-module active"><span class="icon-view_module"></span></a>
                <a href="list-index-lox-coloc.jsp" class="icon-view view-list"><span class="icon-view_list"></span></a>
                
              </div>
              <div class="ml-auto d-flex align-items-center">
                <div>
                 <a href="index_locataire.jsp" class="view-list px-3 border-right active">Annonces logements</a>
                  <a href="list-index-lox-coloc.jsp" class="view-list px-3 border-right">Annonces colocataires</a>
                </div>
                ...
                <div class="select-wrap">
                  ...
                  <select class="form-control form-control-sm d-block rounded-0">
                    <option value="">Afficher annonces :</option>
                    <option value="">Logements</option>
                    <option value="">Colocataire</option>
                  </select>
                </div>
              </div>
            </div>
  ...
  <h2 align="center"><em><strong >Croisez votre colocataire</strong> </em></h2>
          ...
          <div class="col-md-12">
            <div class="property-entry horizontal d-lg-flex">
              ...
              <a href="detailscoloc.jsp?idancoloc=<%=rs.getString(1)%>" class="property-thumbnail h-100">
                ...
                <img src="images/<%=rs.getString(7)%>" alt="Image" class="img-fluid">
              </a>
 
              <div class="p-4 property-body">
                <a href="detailsvis.jsp?idanlog1=<%=rs.getString(1)%>" class="property-favorite"><span class="icon-heart-o"></span></a>
                <h2 class="property-title"><a href="detailscoloc.jsp"><%=rs.getString(15)%></a></h2>
                <span class="property-location d-block mb-3"><span class="property-icon icon-room"></span> <%=rs.getString(6)%></span>
                
                <strong class="property-price text-primary mb-3 d-block text-success"><%=rs.getString(3)%></strong>
                
                <ul class="property-specs-wrap mb-3 mb-lg-0">
                   <li>
                    <span class="property-specs">Activit�</span>
                    <span class="property-specs-number"><%=rs.getString(5)%></span>
                    
                  </li>
                   <li>
                    <span class="property-specs">Je suis</span>
                    <span class="property-specs-number"><%=rs.getString(10)%></span>
                    
                  </li>
                    <li>
                    <span class="property-specs">Publi� en</span>
