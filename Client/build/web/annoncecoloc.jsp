  ...
  <div class="site-wrap">
    ...
    <div class="site-section site-section-sm pb-0">
      <div class="container">
          ...
          <div class="col-md-12">
            <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
              <div class="mr-auto">
                ...
                <a href="view-list.jsp" class="icon-view view-list"><span class="icon-view_list"></span></a>
        ...
        <h2 align="center"><strong >       Trouvez la location qui vous convient</strong> </h2>
        ...
        <%
         ...
         <div class="col-md-6 col-lg-4 mb-4">
            <div class="property-entry h-100">
              <a href="details.jsp?id=<%=rs.getString(1)%>" class="property-thumbnail">
               
                <img src="images/<%=rs.getString(12)%>" alt="Image" class="img-fluid">
              </a>
              <div class="p-4 property-body">
                <a href="#" class="property-favorite active"><span class="icon-heart-o"></span></a>
                <h2 class="property-title"><a href="details.jsp"><%=rs.getString(2)%></a></h2>
                ...
                <ul class="property-specs-wrap mb-3 mb-lg-0">
                  ...
                  <li>
                    ...
                    <span class="property-specs-number"><%=rs.getString(5)%>m�</span>
