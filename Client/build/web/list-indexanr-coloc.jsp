        ...
        <div class="row">
          <div class="col-md-12">
            <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
              <div class="mr-auto">
                <a href="annoncecoloc-anr-coloc.jsp" class="icon-view view-module"><span class="icon-view_module"></span></a>
                <a href="list-indexanr-coloc.jsp" class="icon-view view-list active"><span class="icon-view_list"></span></a>
