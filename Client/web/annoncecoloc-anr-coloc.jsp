        ...
        <div class="row">
          <div class="col-md-12">
            <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
              <div class="mr-auto">
                <a href="annoncecoloc-anr-coloc.jsp" class="icon-view view-module active"><span class="icon-view_module"></span></a>
                <a href="list-indexanr-coloc.jsp" class="icon-view view-list"><span class="icon-view_list"></span></a>
        ...
        <%
         ...
         <div class="col-md-6 col-lg-4 mb-4">
            <div class="property-entry h-100">
              <a href="detailscoloc-anr.jsp?idancoloc=<%=rs.getString(1)%>" class="property-thumbnail">
               
                <img src="images/<%=rs.getString(8)%>" alt="Image" class="img-fluid">
              </a>
              <div class="p-4 property-body">
                <h2 class="property-title"><a href="detailscoloc-anr.jsp?idancoloc=<%=rs.getString(1)%>"><%=rs.getString(16)%></a></h2>
