    ...
    <body>
     ...
     try{
       ...
       String  req1="select * from message where idannon="+id;
        System.out.print ("modifier_ann_coloc "+req1);
    ...
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(images/hero_bg_2.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          <div class="col-md-10">
            <h1 class="mb-2">Modifier l'annonce</h1>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 col-lg-8 mb-5">
            ...
            <form action="" class="p-5 bg-white border" name="formulaire">

       <table width="655" border="0">
       <tr>
    <td width="266"><div class="row form-group">
      <div class="col-md-12 mb-3 mb-md-0">
                   <label class="font-weight-bold" for="Nom">Titre</label>
        <input type="text" name="nom" id="nom" class="form-control" value="<%=titre%>" />
      </div>
    </div></td>
