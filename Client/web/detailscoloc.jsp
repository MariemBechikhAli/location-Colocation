    ...
    <body>
        ...
        <%
            ...
            try {
                ...
                String req = "select * from annoncecolocataire where idancoloc=" + idancoloc;
                 System.out.print("details coloc ++ "+req);
                ResultSet rs = c2.Afficher(req);
               

                while (rs.next()) {
                    idcolocan = rs.getInt(1);
                    no = rs.getString(2);
                    po = rs.getString(3);
        ...
        <div class="site-section site-section-sm">
          ...
          <% try {
                                            ...
                                            Connexion c = new Connexion();
                                            String req = "select * from commentaire where idcoloc='" + idcolocan + "' order by date_pub desc";
                            ...
                            <div class="form-group">
                                <form action="modifierancoloc.jsp">

                                    <input type="hidden" name="idannance" value="<%=idcolocan%> ">
                                    <input type="submit" class="btn btn-outline-info text-center btn-block rounded-0" value="Modifier l'annonce">

                                </form>
                                <br>
                                <form action="supprimer1?id"  >
                                    <input type="hidden" name="id" value="<%=idcolocan%>">
...
System.out.println("prp conx "+req);
                                        ResultSet rs = cc.Afficher(req);
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class="col-md-6 col-lg-4 mb-4">
                                        <div class="property-entry h-100">
                                            <a href="detailscoloc.jsp?idancoloc=<%=rs.getString(1)%>" class="property-thumbnail">
