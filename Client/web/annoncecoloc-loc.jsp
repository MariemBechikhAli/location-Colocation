            ...
            <div class="container">
                <div class="row">
                    <form class="form-search col-md-12" style="margin-top: -100px;" action="recherche.jsp">
                        <div class="row  align-items-end">
                            ...
                            <div class="col-md-3">
                                <label for="list-types">Sexe</label>
                                <div class="select-wrap">
                                    <span class="icon icon-arrow_drop_down"></span>
                            ...
                            <div class="col-md-3">
                                <label for="offer-types">Activité du colocataire</label>
                                <div class="select-wrap">
                                    <span class="icon icon-arrow_drop_down"></span>
                    ...
                    <div class="col-md-12">
                        <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
                            <div class="mr-auto">
                                ...
                                <a href="list-index-loc-coloc.jsp" class="icon-view view-list"><span class="icon-view_list"></span></a>

                            </div>
                            <div class="ml-auto d-flex align-items-center">
                                <div>
                                    <a href="index_locataire.jsp" class="view-list px-3 border-right active">Annonces logements</a>
                                    <a href="annonecoloc-loc.jsp" class="view-list px-3 border-right">Annonces colocataires</a>
                                </div>
                ...
                <div class="site-section site-section-sm bg-light">
                    <%   try {
                            ...
                            System.out.println("annoncecoloc-loc "+req);
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            <div class="property-entry h-100">
                                <a href="detailscoloc-loc.jsp?idancoloc=<%=rs.getString(1)%>" class="property-thumbnail">
                                    ...
                                    <input type="hidden" name="idancoloc" value="<%=idancoloc%>"/>
                                <div class="p-4 property-body">
                                    <a href="interesser.jsp?idancoloc=<%=rs.getString(1)%>" class="property-favorite" onClick="return confirm('Vous êtes intéressé par cette annonce ?' )" > <span class="icon-heart-o"></span></a>
                                    <h2 class="property-title"><a href="detailscoloc-loc.jsp"><%=rs.getString(16)%></a></h2>
                                    ...
                                    <ul class="property-specs-wrap mb-3 mb-lg-0">
                                        ...
                                        <li>
                                            <span class="property-specs">Publié en</span>
