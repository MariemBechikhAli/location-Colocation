                    ...
                    <div class="col-md-12">
                        <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
                            ...
                            <div class="ml-auto d-flex align-items-center">
                                <div>
                                    <a href="list-index_annonceur.jsp" class="view-list px-3 border-right active">Annonces logements</a>
                                    <a href="list-indexanr-coloc.jsp" class="view-list px-3 border-right">Annonces colocataires</a>
                                </div>
                ...
                <div class="row mb-4">
                    <div class="col-md-12">
                        <div class="property-entry horizontal d-lg-flex">
                            ...
                            <a href="detailsanrlog.jsp?idanlog1=<%=rs.getString(1)%>" class="property-thumbnail h-100">

                                <img src="images/<%=rs.getString(11)%>" alt="Image" class="img-fluid">
                            </a>

                            <div class="p-4 property-body">
                                <a href="detailsanrlog.jsp?idanlog1=<%=rs.getString(1)%>" </span></a>
                                <h2 class="property-title"><a href="detailsanrlog.jsp?idanlog1=<%=rs.getString(1)%>"><%=rs.getString(2)%></a></h2>
