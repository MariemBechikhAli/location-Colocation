            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 col-lg-8 mb-5">
                        ...
                        <%
                            String idanlog1 = request.getParameter("idannance");
                            String titre = "";
                            String adrlog = "";
                            String type = "";
                            String surface = "";
                            ...
                            try {
                                ...
                                while (rs.next()) {
                                   idanlog= rs.getInt(1);
                                    ...
                                    adrlog = rs.getString(3);
                                    type = rs.getString(4);
                                    surface = rs.getString(5);
                                    nbre_piece = rs.getString(6);
                                    meuble = rs.getString(7);
                                    description = rs.getString(8);
                                    loyer = rs.getString(9);
                                    caution = rs.getString(10);
                                    idAn = rs.getInt(12);
                                    etat = rs.getString(13);
                        ...
                        <form action="update_annonce_log?id" class="p-5 bg-white border">
                            <div class="row form-group">
                                <div class="col-md-12">
                                    <table width="655" border="0">
                                        <h2 align="center">Modifier votre annonce</h2>
                                        <tr>
                                            <td width="266"><div class="row form-group">
                                                    <div class="col-md-12 mb-3 mb-md-0">
                                                        <label class="font-weight-bold" for="Titre">Titre</label>
                                                        <input type="text" id="email" name="titre" class="form-control" placeholder="Titre" value="<%=titre%>">
                                                    </div>
                                                </div></td>
                                            ...
                                            <td width="266">  <div class="row form-group">
                                                    <div class="col-md-12 mb-3 mb-md-0">
                                                        ...
                                                        <select name="adr" class="form-control d-block rounded-0">
                                                            <option><%=adrlog%></option>
                                        ...
                                        <tr>
                                            <td colspan="2"><div class="row form-group">
                                                    <div class="col-md-12">
                                                        ...
                                                        <textarea name="Description" id="message" cols="30" rows="5" class="form-control" value=""><%=description%></textarea>
                                                    </div>
                                                </div></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>      <div class="row form-group">
                                                ...
                                                <td>  <div class="row form-group">
                                                    <div class="col-md-12 mb-3 mb-md-0">
                                                        ...
                                                        <select name="nbr"class="common-input mb-20 form-control">
                                                            <option><%=nbre_piece%></option>
                                                            <option>1</option>
                                                            <option>2</option>
                                                            <option>3</option>
                                                            <option>4</option>
                                        ...
                                        <tr>
                                            <td> <div class="row form-group">
                                                    <div class="col-md-12">
                                                        <label class="font-weight-bold" for="Meublé"> Meublé</label> 
                                                ...
                                                <td> <div class="row form-group">
                                                    <div class="col-md-12">
                                                        ...
                                                        <input type="number" id="subject" name="surface" class="form-control" placeholder="surface " value="<%=surface%>">
                                                    </div>
                                                </div></td>
                                                        ...
                                                        <table width="495" height="135" border="0">
                                                            <tr>
                                                                ...
                                                                <td ligne="top" width="298"><label>
                                                                        <input type="checkbox" name="Ascenseur" value="Ascenseur" checked="checked"   />
                                                                    </label>
                                                                    Ascenseur 
                                                                    <% } else {%>
                                                                <td ligne="top" width="298"><label>
                                                            ...
                                                            <tr>
                                                                ...
                                                                %>
                                                                <td height="26"><label>
                                                                        <input type="checkbox" name="WiFi" value="WiFi" checked="checked"   />
                                                                    </label>
                                                                    WiFi </td>
                                                                    <% } else {%>
                                                                <td height="26"><label>
                                                            ...
                                                            <tr>
                                                                ...
                                                                %>
                                                                <td><label>    
                                                                        <input type="checkbox" name="Climatisation" value="Climatisation" checked="checked"  />
                                                                    </label>
                                                                    Climatisation</td>
                                                                    <% } else {%>
                                                                <td><label>    
                                                                    ...
                                                                    %>
                                                                <td><label>    
                                                                        <input type="checkbox" name="Terrasse" value="Terrasse" checked="checked"  />
                                                                    </label>
                                                                    Terrasse</td>
                                                                    <% } else {%>
                                                                <td><label>    
                                                            ...
                                                            <tr>
                                                                ...
                                                                %>
                                                                <td><label>    
                                                                        <input type="checkbox" name="sdb" value="Salle de bain privée" checked="checked"  />
                                                                    </label>
                                                                ...
                                                                <td><label>    
                                                                    ...
                                                                    %>
                                                                <td><label>    
                                                                        <input type="checkbox" name="Balcon" value="Balcon" checked="checked"  />
                                                                    </label>
                                                                    Balcon</td>
                                                                    <% } else {%>
                                                                <td><label>    
                                                            ...
                                                            <tr>
                                                                ...
                                                                %>
                                                                <td><label>    
                                                                        <input type="checkbox" name="machine" value="Machine à laver" checked="checked"  />
                                                                    </label>
                                                                    Machine à laver</td>
                                                                    <% } else {%>
                                                                <td><label>    
                                                                ...
                                                                %>
                                                                <td><label>    
                                                                        <input type="checkbox" name="Jardin" value="Jardin" checked="checked"  />
                                                                    </label>
                                                                    Jardin</td>
                                                                    <% } else {%>
                                                                <td><label>    
                                                            ...
                                                            <tr>
                                                                ...
                                                                %>
                                                                <td><label>    
                                                                        <input type="checkbox" name="Chaufage" value="Chaufage" checked="checked"  />
                                                                    </label>
                                                                    Chaufage</td>
                                                                    <% } else {%>
                                                                <td><label>    
                                                                ...
                                                                %>
                                                                <td><label>    
                                                                        <input type="checkbox" name="Piscine" value="Piscine" checked="checked"  />
                                                                    </label>
                                                                    Piscine</td>
                                                                    <% } else {%>
                                                                <td><label>    
                                        ...
                                        <tr>
                                            <td> <div class="row form-group">
                                                    <div class="col-md-12 mb-3 mb-md-0">
                                                        ...
                                                        <input type="number" id="email" name="caution" class="form-control" placeholder="Caution" value="<%=caution%>">
                                                    </div>
                                                </div></td>
                                            <td><div class="row form-group">
                                                    <div class="col-md-12">
                                                        <label class="font-weight-bold" for="prix">Loyer </label>
                                                        <input type="number" id="subject" name="prix" class="form-control" placeholder="loyer " value="<%=loyer%>">
                                                    </div>
                                                </div></td>
                                ...
                                <input type="submit" value="Enregistrer" class="btn btn-success text-white btn-block rounded-0">
