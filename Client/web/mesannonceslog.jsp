    ...
    <body>
        ...
        <div class="site-section site-section-sm pb-0">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
                            <div class="mr-auto">
                                <a href="mesannonceslog.jsp" class="icon-view view-module active"><span class="icon-view_module"></span></a>
                                <a href="list-mes_annonces.jsp" class="icon-view view-list"><span class="icon-view_list"></span></a>
                ...
                <h2 align="center"><em><strong > Mes annonces </strong> </em></h2>
                <div class="site-section site-section-sm bg-light">
                    <%   try {
                            Connexion c = new Connexion();
                            String req = "select * from annoncelogement where etat='active' and idAn=" + id;
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            <div class="property-entry h-100">
                                <a href="detailsanrlog-anr.jsp?idanlog1=<%=rs.getString(1)%>" class="property-thumbnail">

                                    <img src="images/<%=rs.getString(11)%>" alt="Image" class="img-fluid">
                                </a>
                                <div class="p-4 property-body">
                                    <a href="supprimer?id=<%=rs.getString(1)%>" class="property-favorite active" onClick="return confirm('Vous voulez vraiment supprimer cette annonce ?')" ><span class="icon-trash"></span></a>
                                    <h2 class="property-title"><a href="detailsanrlog-anr.jsp"><%=rs.getString(2)%></a></h2>
                                    <span class="property-location d-block mb-3"><span class="property-icon icon-room"></span><%=rs.getString(3)%></span>
                                    <strong class="property-price text-primary mb-3 d-block text-success"><%=rs.getString(9)%>DT</strong>
