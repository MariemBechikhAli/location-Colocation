    ...
    <body>
        <%
            ...
            try {
                ...
                String req = "update annonceur set nom='" + nom + "',prenom='" + prenom + "', date_naiss='" + date_naiss + "',sexe='" + sexe + "',activite='" + act + "',photo='" + photo + "',adr='" + adr + "',tel=" + tel + ",email='" + email + "',password='" + password + "', etat='" + etat + "', identifiant='" + cit + "'  where idAn=" + id;
                System.out.print(req);
                C.modifier(req);
                response.sendRedirect("profilan.jsp");
            } catch (Exception e) {
