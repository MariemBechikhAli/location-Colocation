        ...
        <div class="row">
          <div class="col-md-12">
            <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
              <div class="mr-auto">
                <a href="annoncecolocvis.jsp" class="icon-view view-module"><span class="icon-view_module"></span></a>
                <a href="list-indexvis-coloc.jsp" class="icon-view view-list active"><span class="icon-view_list"></span></a>
                
              </div>
              <div class="ml-auto d-flex align-items-center">
                <div>
                   <a href="list-index.jsp" class="view-list px-3 border-right active">Annonces logements</a>
        ...
        <%
          ...
          <div class="col-md-12">
            <div class="property-entry horizontal d-lg-flex">
              ...
              <a href="details-coloc-vis.jsp?idancoloc=<%=rs.getString(1)%>" class="property-thumbnail h-100">
                
                <img src="images/<%=rs.getString(8)%>" alt="Image" class="img-fluid">
              </a>
 
              <div class="p-4 property-body">
                <a href="detailsvis.jsp?idanlog1=<%=rs.getString(1)%>" ></a>
