        ...
        <%
          ...
          <div class="col-md-12">
            <div class="property-entry horizontal d-lg-flex">
              ...
              <a href="detailsanrlog-anr.jsp?idanlog1=<%=rs.getString(1)%>" class="property-thumbnail h-100">
            ...
            <a href="supprimer?id=<%=rs.getString(1)%>" class="property-favorite active" onClick="return confirm('Vous voulez vraiment supprimer cette annonce ?')" ><span class="icon-trash"></span></a>
                <h2 class="property-title"><a href="detailsanrlog-anr.jsp?idanlog1=<%=rs.getString(1)%>"><%=rs.getString(2)%></a></h2>
